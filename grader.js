#!/usr/bin/env node
/*
Automatically grade files for the 
presence of specified HTML 
tags/attributes.
Uses commander.js and cheerio. Teaches 
...
if(require.main == module) {
    program
        .option('-c, --checks 
<check_file>', 'Path to checks.json', 
